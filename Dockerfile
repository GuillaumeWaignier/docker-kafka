...
ARG CONFLUENT_MAJOR_VERSION=6
ARG CONFLUENT_MINOR_VERSION=2
...
RUN apt-get update -y \
    ...
    && wget -O confluent.zip https://packages.confluent.io/archive/${CONFLUENT_MAJOR_VERSION}.${CONFLUENT_MINOR_VERSION}/confluent-community-${CONFLUENT_MAJOR_VERSION}.${CONFLUENT_MINOR_VERSION}.${CONFLUENT_FIX_VERSION}.zip \
